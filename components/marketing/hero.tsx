        ...
        <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-background/0">
          <Container className="relative hidden lg:block overflow-hidden">
            <button className="group relative grid overflow-hidden rounded-full px-2 py-1 shadow-[0_1000px_0_0_hsl(0_0%_15%)_inset] transition-colors duration-200 mx-auto">
              ...
              <span className="z-10 py-0.5 text-sm text-foreground dark:text-neutral-200 flex items-center group-hover:dark:text-white group-hover:text-white">
                <span className="px-2 py-[0.5px] h-[18px] tracking-wide flex items-center justify-center rounded-full bg-gradient-to-r  text-[9px] font-medium mr-2 text-white dark:bg-gradient-to-r from-pink-400 to-pink-600 dark:text-white">
                  NEW
                </span>
          ...
          <Container delay={0.15}>
            <h1 className="text-4xl md:text-4xl lg:text-7xl font-bold text-center !leading-tight max-w-4xl mx-auto">
              Transform your <span className="">studies </span>
              with AI Precision
            </h1>
          </Container>
          <Container delay={0.2}>
          ...
          <Container delay={0.3} className="relative">
            <div className="relative rounded-xl lg:rounded-[32px] border border-border p-2 backdrop-blur-lg mt-10 max-w-6xl mx-auto">
              <div className="absolute top-1/8 left-1/2 -z-10 bg-[var(--primary)] w-1/2 lg:w-3/4 -translate-x-1/2 h-1/4 -translate-y-1/2 inset-0 blur-[4rem] lg:blur-[10rem] animate-image-glow"></div>
              ...
              <div className="rounded-lg lg:rounded-[22px] border border-border bg-background">
                <Image
                  src={
                    theme === "dark" ? "/dashboard.png" : "/dashboard-ligh.png"
                  }
                  alt="dashboard"
                  width={1920}
                  height={1080}
            ...
            <div className="bg-gradient-to-t from-black/50 rounded-2xl  dark:from-background to-transparent absolute bottom-0 inset-x-0 w-full h-1/2"></div>
          </Container>
        </div>
      </div>
    </div>
