      ...
      <Container className="py-20 max-w-6xl mx-auto">
        <div className="relative flex flex-col items-center justify-center py-12 lg:py-20 px-0 rounded-2xl lg:rounded-3xl bg-background/20 text-center border border-foreground/20 overflow-hidden">
          ...
          <motion.div
            ...
            style={{
              background:
                "conic-gradient(from 0deg at 50% 50%, #a855f7 0deg, #ff82b8 180deg, #ff93c9 360deg)",
            }}
            animate={{
              rotate: 360,
            }}
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-heading font-medium !leading-snug">
            ...
            <span className="font-subheading italic">academic success</span> ?
          </h2>
          <p className="text-sm md:text-lg text-center text-foreground max-w-2xl mx-auto mt-4">
            Join thousands of students who have already improved their grades
            and study efficiency with
            <span className="hidden lg:inline">Usoro</span>
          </p>
